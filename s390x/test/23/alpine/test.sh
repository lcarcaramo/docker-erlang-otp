...
suite_start
        print_test_case "It can run an Erlang Script:"
                build "runs-erlang-scripts" 
                docker run --rm --name runs-erlang-scripts "runs-erlang-scripts"
                cleanup "runs-erlang-scripts"
suite_end
